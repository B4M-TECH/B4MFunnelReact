...
var B4MFunnel = (() => {
  ...
  var parseScriptConfig = (script) => {
    ...
    const artistSpotifyId = normalizeParam(
      (_m = (_l = (_k = (_j = params == null ? void 0 : params.get("artistSpotifyId")) != null ? _j : dataset.artistSpotifyId) != null ? _k : dataset["artist-spotify-id"]) != null ? _l : dataset["b4mArtistSpotifyId"]) != null ? _m : dataset["b4m-artist-spotify-id"]
    );
    const sidebar = normalizeSidebar(
      (_p = (_o = (_n = params == null ? void 0 : params.get("sidebar")) != null ? _n : dataset.sidebar) != null ? _o : dataset["b4mSidebar"]) != null ? _p : dataset["b4m-sidebar"]
    );
    const targetId = normalizeParam(
      (_u = (_t = (_s = (_r = (_q = params == null ? void 0 : params.get("targetId")) != null ? _q : params == null ? void 0 : params.get("target")) != null ? _r : params == null ? void 0 : params.get("container")) != null ? _s : dataset.targetId) != null ? _t : dataset.target) != null ? _u : dataset.container
    );
    return {
      ...
      artistSpotifyId: artistSpotifyId != null ? artistSpotifyId : void 0,
  ...
  var autoInit = () => {
    ...
    const artistSpotifyId = (_y = (_x = (_w = (_v = target.dataset.artistSpotifyId) != null ? _v : target.getAttribute("data-artist-spotify-id")) != null ? _w : target.getAttribute("data-b4m-artist-spotify-id")) != null ? _x : scriptConfig.artistSpotifyId) != null ? _y : void 0;
    const sidebar = (_C = (_B = (_A = (_z = normalizeSidebar(target.dataset.sidebar)) != null ? _z : normalizeSidebar(target.getAttribute("data-sidebar"))) != null ? _A : normalizeSidebar(target.getAttribute("data-b4m-sidebar"))) != null ? _B : scriptConfig.sidebar) != null ? _C : void 0;
